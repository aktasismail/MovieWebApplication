...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20231110192229_addcomment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayer.Comments", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MovieId = 1,
                            Tittle = "ekgfmwegk",
                            UserId = "07217690-eb89-47c0-a1bb-2b51f0bd0c55"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "f12c1ee7-dbc9-44d8-897c-ef92e8e31d40",
                            ConcurrencyStamp = "9bbf0e75-bf38-4af1-8e23-da34c834d12b",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "b6dce25a-84e2-48cf-b14e-ca112d79906d",
                            ConcurrencyStamp = "e8cb4353-9135-494d-92c8-a912b15030a6",
                            Name = "Admin",
            ...
            modelBuilder.Entity("EntityLayer.Comments", b =>
                {
                    b.HasOne("EntityLayer.Movies", "Movies")
                        .WithMany("Comments")
                        .HasForeignKey("MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EntityLayer.ApplicationUser", "User")
                        .WithMany("Comments")
